...
$username = "dsmr.apps@gmail.com"; $password = 'ddd41eba3539e9bbcc7d12e551aab4ac';

    $useruploadfolder = "/storage";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "/storage";
    ...
    $useruploadfolder = "/public/img";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "/public/img";
