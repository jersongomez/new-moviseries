...
<div class="container">
    <table id="data-table" class="display" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <th><input style="max-width: 70px;" type="text" type="datetime"></th>
            <th><select name="" id="">
...
<script>
    ...
    $(function () {
        table = $('#data-table').DataTable({
            "ajax": {
                ...
                "bProcessing": true,
                "bServerSide": true,
                "url": "<?php echo base_url('admin/series/list')?>",
                "data": {
    ...
    function delete_item(id) {
        ...
        $.confirm({
            ...
            content: 'Se eliminaran tambien las temporadas y capitulos relacionados',
            ...
            confirm: function () {
                ...
                if (!running) {
                    running = true;
                    $.ajax({
                        url: '<?php echo base_url('admin/eliminar-serie') ?>',
                        type: 'post',
                        data: 'serie_id=' + id,
