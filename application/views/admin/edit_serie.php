...
<div class="container">
    ...
    <h2 class="text-center" style="background-color: #E91E63; color: #fff; text-transform: uppercase;">Editar
        Pelicula <?php echo $serie->serie_id ?></h2>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-12">
                ...
                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                    ...
                    <input value="<?php echo $serie->serie_name ?>" required name="name" type="text" class="form-control"
                           id="title"
            ...
            <div class="col-md-3 col-sm-12">
                ...
                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                    ...
                    <input required name="year" value="<?php echo $serie->year ?>" type="number" class="form-control"
                           id="year"
                           placeholder="Año">
                </div>
            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div style="max-height: 400px;">
                                    <img id="image" src="<?php echo $serie->cover ?>">
                                </div>
            ...
            <textarea required style="height: 80px;" class="form-control" name="short_description"
                      ...
                      cols="30" rows="10"
                      placeholder="Descripción corta"><?php echo $serie->short_description ?></textarea>
            </div>

            <div class="col-12">
                <hr>
                <textarea name="description" id="editor" cols="30"
                          rows="10"><?php echo $serie->description ?></textarea>
            </div>
            ...
            <div class="col-md-9 col-sm-12">
                ...
                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                    ...
                    <input required type="text" class="form-control" id="key_words"
                           value="<?php echo $serie->key_words ?>">
                </div>
            </div>
            <div class="col-md-3 col-sm-12 text-right">
                <hr>
    ...
    $(function () {
        ...
        $('#form-edit').submit(function () {
            ...
            if (img64 == null) {
                ...
                var id = <?php echo $serie->serie_id ?>;
                var titulo = $('#title').val();
                var year = $('#year').val();
                var descripcion_corta = $('#short_description').val();
                var html = editor.getData();
                var fd = new FormData();
                fd.append('serie_id', id);
                ...
                $.ajax({
                    url: '<?php echo base_url('/admin/serie/edit') ?>',
                    type: 'post',
                    data: fd,
                    processData: false,
                    contentType: false,
