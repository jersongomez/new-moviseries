...
<div class="container">
    ...
    <h2 class="text-center" style="background-color: #E91E63; color: #fff; text-transform: uppercase;">Nueva
        Serie</h2>


    <form id="form-new-movie" action="<?php echo base_url('/admin/insert-serie') ?>" method="post">

        <div class="row">


            <div class="col-md-9 col-sm-12">
                <label class="sr-only" for="inlineFormInputGroup">Nombre de la Serie</label>
            ...
            <div class="col-md-3 col-sm-12">
                ...
                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                    ...
                    <input required name="year" value="2017" type="number" class="form-control" id="year"
                           placeholder="Año">
                </div>
            </div>
            ...
            <div class="col-md-9 col-sm-12">
                <hr>
                <select id="categories" required class="js-multiple form-control" multiple="multiple">
...
<script>
    ...
    $(function () {
        ...
        $('#form-new-movie').submit(function () {
            ...
            if (!running) {
                ...
                fd.append('categories', categorias);
                fd.append('html', html);
                fd.append('key_words', $('#key_words').val());


                $.ajax({
                    url: $('#form-new-movie').attr('action'),
                    type: 'post',
                    data: fd,
                    processData: false,
                    contentType: false,
                    success: function (data) {
                        ...
                        running = false;
                        if (data != -1) {
                            window.location = '<?php echo base_url() ?>admin/series/' + data+'/temporadas';
                        } else {
                            alert("No se pudo crear la serie");
                        }
                    }
                });
            }
